...
int main()
{
    ...
    std::cout << "DLL (convert to string): " << (dll::sample_to_string(buf, number)) << std::endl;
    std::cout << "DLL (convert string to long): " << dll::sample_to_int64(buf) << std::endl;
    ...
    std::cout << "DLL sorted: " << (dll::sample_checkSort2(numbers_unsorted) ? "Yes" : "No") << std::endl;
    std::cout << "Compare 2 strings: Mike, Mike" << std::endl;
    std::cout << "DLL Compare result: " << dll::sample_compare("Mike", "Mike") << std::endl;
